...
For downstream linear probing, this repository provides a feature extraction script. The script does not directly train the downstream classifier. It extracts `.h5` feature files from CT volumes, which can then be used for linear probing.
